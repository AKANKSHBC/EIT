                ...
                <form action="{{Route('storeLecturer')}}" method="POST">
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            ...
                            <label for="lname" class="block text-sm font-medium text-gray-700"> Name </label>
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm"> Dr./Mr./Mrs./Ms. </span>
                                <input type="text" name="lname" id="lname" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="lecturer name">
                            </div>
                            </div>
                        </div>
                        <div class="mt-10">
                            <legend class="contents text-sm font-medium text-gray-900">Grade</legend>
                            <div class="mt-4 space-y-4">
                                <div class="flex items-center">
                                    <input id="push-everything" name="grade" value="Grade A" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="push-everything" class="ml-3 block text-sm font-medium text-gray-700"> Grade-A </label>
                                </div>
                                <div class="flex items-center">
                                    <input id="push-email" name="grade" value="Grade B" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="push-email" class="ml-3 block text-sm font-medium text-gray-700"> Grade-B </label>
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-3 sm:col-span-2">
                                <label for="first-name" class="block text-sm font-medium text-gray-700">Joining Date</label>
                                <input type="date" name="joiningDate" id="first-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
